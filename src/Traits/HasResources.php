...
use Slakbal\Gotowebinar\Http\Integrations\GotoWebinar\Resources\AttendeesResource;
...
trait HasResources
{
    ...
    public function attendees(): AttendeesResource
    {
        return new AttendeesResource($this);
    }
}
