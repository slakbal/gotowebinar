...
class GetAttendeeSurveys extends Request
{
    use AcceptsJson;
    ...
    {
        return "/organizers/{$this->organizerKey}/webinars/{$this->webinarKey}/sessions/{$this->sessionKey}/attendees/{$this->registrantKey}/surveys";
    }
}
